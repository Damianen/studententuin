...
// Source: internal/app/ports/password_hasher.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/ports/password_hasher.go -destination=internal/mocks/mock_password_hasher.go -package=mocks
//
...
func (m *MockPasswordHasher) Compare(passwrod, hash string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Compare", passwrod, hash)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPasswordHasherMockRecorder) Compare(passwrod, hash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Compare", reflect.TypeOf((*MockPasswordHasher)(nil).Compare), passwrod, hash)
}
