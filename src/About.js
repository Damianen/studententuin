          ...
          <div className="px-4 py-6 lg:py-3 lg:px-8 lg:w-full">
            <div className="max-w-xl mb-4">
              ...
              <p className="text-black text-base md:text-lg">
                ...
                om gewoon in rond te kunnen spelen, zodat ze zich volledig
                kunnen concentreren op hun leerproces en ontwikkeling. Hierbij
                willen vooral de nadruk leggen op een soort zandbak waarbij
                studenten al hun eigen applicaties op kunnen hosten en
        ...
        <div className="flex flex-col items-center justify-between w-full lg:flex-row mt-6">
          <div className="px-4 py-6 lg:py-3 lg:px-8 lg:w-full">
            <div className="max-w-xl mb-4">
              ...
              <br />
              <p className="text-black text-base md:text-lg">
                Wij zijn een groep eerstejaars IT-studenten die niet zoeken naar
                problemen maar juist naar oplossingen. We begrijpen de belangen
                van online omgevingen voor studenten en het tekort aan gratis
                omgevingen. Daarom hebben wij besloten met behulp van school om
                een platform te creëren waar studenten hun eigen omgevingen
                kunnen beheren, zowel gratis als met een extra pakket indien
                nodig. Ons verdienmodel is erop gericht om de serverkosten te
                dekken. We hebben geen winstoogmerk maar een educatief
                ondersteuningsdoel voor zowel gebruikers als voor onszelf.
              </p>
            </div>
          </div>
