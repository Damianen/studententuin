                    ...
                    <div className="joyride-step-1 mb-12 lg:mb-0 lg:max-w-lg lg:pr-4">
                        <div className="max-w-xl mb-4">
                            ...
                            <p className="text-black text-base md:text-lg">
                                Heb jij een een betrouwbare online omgeving
                                nodig? Wij bieden een gratis online omgeving aan
                                voor alle studenten. Hierbij kan je gebruik
                    ...
                    <div className="mb-12 lg:mb-0 lg:max-w-lg lg:pr-4">
                        <div className="max-w-xl mb-4">
                            ...
                            <p className="text-black pt-6 text-base md:text-lg">
                                Studententuin.nl is een platform voor studenten
                                door studenten. Iedereen kent het wel, je hebt
                                voor een school project een online omgeving
                                nodig maar je wilt natuurlijk niet te veel
                                betalen. Bij studententuin.nl kan je gratis een
                                online omgeving aanvragen. Indien je meer
                                resources nodig hebt kan je bij ons ook terecht.
                            </p>
                        </div>
                    ...
                    <div className="joyride-step-2 mb-12 lg:mb-0 lg:max-w-lg lg:pr-4">
                        <div className="max-w-xl mb-4">
                            ...
                            <p className="text- text-base md:text-lg">
                                Voorkom dat je vastloopt bij het opzetten van je
                                online omgeving. Wij hebben een handleiding
                                geschreven waarin stap voor stap wordt uitgelegd
                                hoe je een online omgeving kan aanvragen.
                                Hierbij wordt er ook uitgelegd hoe je gebruik
                                kan maken van de verschillende technieken die
                                wij aanbieden voor je online omgeving.
                                <br />
                                <br />
                            </p>
                        </div>
                ...
                <div className="joyride-step-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                    <div className="bg-white overflow-hidden shadow-lg transition-transform transform hover:scale-105">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                Beste pakket voor studenten die iets kleins
                                willen bouwen voor bijvoorbeeld huiswerk
                                projecten
                            </p>
                    ...
                    <div className="bg-white overflow-hidden shadow-lg transition-transform transform hover:scale-105">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                Als je net iets meer nodig hebt voor je
                                projecten
                            </p>
                            <br />
                            <p className="text-4xl font-bold text-gray-800 mb-4">
                    ...
                    <div className="bg-white overflow-hidden shadow-lg transition-transform transform hover:scale-105">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                Voor meerdere hobbyprojecten die ieder een eigen
                                subdomein nodig heeft
                            </p>
                            <p className="text-4xl font-bold text-gray-800 mb-4">
                ...
                <div className="joyride-step-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 mb-6 py-6 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-16 lg:px-0">
                    <div className="flex flex-col items-center justify-center h-full text-center border bg-white shadow-xl ">
                        <div className="flex flex-col items-center justify-center h-full text-center p-4">
                            ...
                            <p className="mt-2">
                                Node.js is een open-source, cross-platform
                                JavaScript runtime environment en library voor
                                het uitvoeren van JavaScript-code
                            </p>
                        </div>
                    </div>
                    ...
                    <div className=" hidden flex flex-col items-center justify-center h-full text-center border bg-white shadow-xl ">
                        <div className="flex flex-col items-center justify-center h-full text-center p-4">
                            ...
                            <p className="mt-2">
                                .NET is een veelzijdig framework voor het bouwen
                                van moderne, schaalbare applicaties voor web,
                                mobiel en desktop.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center h-full text-center border bg-white shadow-xl ">
                        <div className="flex flex-col items-center justify-center h-full text-center p-4">
                            ...
                            <p className="mt-2">
                                Microsoft SQL Server is een krachtige
                                relationele databasebeheersysteem voor het
                                opslaan en beheren van gegevens.
                            </p>
                        </div>
                    </div>
                    <div className="relative inset-0 bg-gray-500 bg-opacity-30 flex items-center justify-center">
                    ...
                    <div className="hidden flex flex-col items-center justify-center h-full text-center border bg-white shadow-xl ">
                        <div className="flex flex-col items-center justify-center h-full text-center p-4">
                            ...
                            <p className="mt-2">
                                MySQL is een populaire open-source database die
                                vaak wordt gebruikt voor webapplicaties vanwege
                                zijn snelheid en flexibiliteit.
                            </p>
                        </div>
                    </div>
                </div>
