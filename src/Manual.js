                                ...
                                <div className="flex min-h-full flex-col justify-start px-6 py-12 lg:px-8 space-y-7">
                                    ...
                                    <div className="sm:mx-auto sm:w-full sm:max-w-5xl">
                                        ...
                                        <p className="mt-3">
                                            ...
                                            of je site te zwaar is en of je te
                                            veel opslag gebruikt. onder het
                                            tabje analytics kan je zien hoeveel
                                            geheugen je al hebt gebruikt en
                                            hoeveel je nog over hebt. Ook kan je
                                            zien of je site te veel CPU
                                            gebruikt. Met deze informatie kan je
                                            misschien besluiten om je site te
                            ...
                            <div className="py-4">
                                <div className="flex min-h-full flex-col justify-start px-6 py-12 lg:px-8 space-y-7">
                                    <div className="sm:mx-auto sm:w-full sm:max-w-5xl">
                                        ...
                                        <p className="mt-3">
                                            Deze pagina dient als handleiding
                                            voor het tabje domein op jouw
                                            omgeving. Hierin wordt er uitgelegd
                                            wat precies de domein tab is en waar
                                            je het kan vinden.
                                        </p>
                                    </div>
                                    <hr className="h-0.5 my-8 w-9/12 mx-auto border-0 bg-primary-green opacity-20" />
                                    <div className="sm:mx-auto sm:w-full sm:max-w-5xl">
                                        ...
                                        <p className="mt-3">
                                            Een domein is een unieke naam die je
                                            kan gebruiken om je site te vinden.
                                            Een domein is een soort adres dat je
                                            kan gebruiken om je site te
                                            bezoeken. Een domein is uniek en kan
                                            maar een keer gebruikt worden. Een
                                            domein kan je kopen bij
                                            verschillende bedrijven zoals google
                                            of hostnet. Een domein kan je
                                            koppelen aan je site zodat mensen je
                                            site kunnen vinden. Bij
                                            studententuin hebben wij al een
                                            domein die je kan gebruiken waarbij
                                            je een "subdomein" bij ons krijgt.
                                            met behulp van dit subdomein kunnen
                                            mensen jouw site vinden.
                                        </p>
                                    </div>
                                    <hr className="h-0.5 my-8 w-9/12 mx-auto border-0 bg-primary-green opacity-20" />
                                    <div className="sm:mx-auto sm:w-full sm:max-w-5xl">
                                        ...
                                        <p className="mt-3">
                                            De domein tab kan je vinden onder
                                            "jouw omgeving". Om naar jouw
                                            omgeving te gaan kan je klikken op
                                            de knop jouw omgeving rechts
                                            bovenin. Hierna kan je op de tab
                                            domein klikken om jouw domein te
                                            bekijken. Hier kan je jouw domein
                                            inzien en indien je een basis of
                                            premium pakket hebt meerdere
                                            domeinen aanmaken.
                                        </p>
                                    </div>
                                    <hr className="h-0.5 my-8 w-9/12 mx-auto border-0 bg-primary-green opacity-20" />
