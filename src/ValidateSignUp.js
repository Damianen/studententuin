...
const validateSubdomainRequestChaiExpect = (req, res, next) => {
    try {
        ...
        expect(req.body.subdomainName).to.match(
            /^[a-zA-Z0-9]{1,15}$/,
        ...
        expect(req.body.emailAddress, "Email adres veld kan niet leeg zijn").to
            .not.be.empty;
        expect(req.body.emailAddress).to.match(
        ...
        expect(req.body.password).to.match(
        ...
        expect(req.body.password).to.not.match(
            req.body.subdomainName,
        ...
        expect(req.body.productPackage).to.match(
            /^(free|basic|premium)$/,
