...
const validateSubdomainRequestChaiExpect = (req, res, next) => {
  try {
    ...
    assert(req.body.emailAdress, "emailAdress field is missing or incorrect");
    chai
      .expect(req.body.emailAdress, "emailAdress field is missing or incorrect")
      .to.be.a("string");
    chai.expect(
